...
const CleanNavbar = () => {
  ...
  return (
    <>
      <nav className="w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-full">
        <div className="px-4 sm:px-6 lg:px-8 py-3 sm:py-4 h-full flex items-center w-full justify-between">
          <div className="flex flex-1 items-center justify-between">
            ...
            {/* Desktop Navigation */}
            <DesktopNavbar isSignedIn={isSignedIn}/>
